...
Fil uses Apple's on-device Foundation Models to suggest a short title for a note. This runs on
your device. Your note content is not sent to us or to a cloud service for this.
