...
| 17b | **Name** | `Fil: Folders Outside the App` · `Lock screen & home screen` (28 / 25 chars). "Fil" stays the first word. The name states the category; the subtitle carries both searchable surfaces. |
